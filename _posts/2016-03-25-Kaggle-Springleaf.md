...
tags: []
---
Let's take a look at a Kaggle competition dataset and R code from author, Darragh. One of the interesting things about this Kaggle dataset is that we don't know much about the set itself and we need to figure everything out from scratch.  That is what this code does well and we will break down each piece of it to make sure we understand how and why it is done.  Remember, each time we encounter a new chunk of code we should be thinking why is this necessary, or, what is it we want to do next? I've included little statements about our 'Goals' to get you started thinking this way. Here is [the website of the Kaggle competition](https://www.kaggle.com/c/springleaf-marketing-response), and you can obtain this [code](https://www.kaggle.com/darraghdog/springleaf-marketing-response/explore-springleaf/notebook) through the generosity of Darragh.  
